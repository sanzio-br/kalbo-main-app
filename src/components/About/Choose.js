            ...
            <div className="container">
                <div className="row row-50 justify-content-center align-items-xl-center">
                    ...
                    <div className="col-md-10 col-lg-7 col-xl-6">
                        <h3 className="text-spacing-25 font-weight-normal title-opacity-9" style={{'color':'var(--red)'}}>Why choose us</h3>
                        {/* <!-- Bootstrap tabs--> */}
                        <p>We are a world class travel agency that offers poket friendly tours.</p>
                        <ul className="row-16 list-0 list-custom list-marked list-marked-sm list-marked-secondary">
                        <li>Experienced Team</li>
                        <li>Poket friendly trips</li>
                        <li>Quality Services</li>
                        <li>Wide variety of holiday choices</li>
                      </ul>
                    </div>
                </div>
            </div>
